...
option_parser.add_option(
    ...
    + "aggregationMethod to set on output. One of: %s" % ", ".join(aggregationMethods),
    default="average",
    type="string",
)
option_parser.add_option(
...
if not relevant_rras:
    err = (
        "[ERROR] Unable to find any RRAs with consolidation function: %s"
...
for datasource in datasources:
    ...
    for precision, points in reversed(archives):
        ...
        print(
            " migrating %d datapoints from archive %d"
