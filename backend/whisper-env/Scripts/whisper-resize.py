...
option_parser.add_option(
    "--xFilesFactor", default=None, type="float", help="Change the xFilesFactor"
)
option_parser.add_option(
    "--aggregationMethod",
    default=None,
...
option_parser.add_option(
    "--force", default=False, action="store_true", help="Perform a destructive change"
)
option_parser.add_option(
    "--newfile",
    default=None,
...
whisper.create(
    newfile, new_archives, xFilesFactor=xff, aggregationMethod=aggregationMethod
)
            ...
            if newvalues:
                ...
                if non_none and 1.0 * len(non_none) / len(newvalues) >= xff:
                    newdatapoints.append(
                        [
                            tinterval[0],
                            whisper.aggregate(aggregationMethod, non_none, newvalues),
                        ]
                    )
